...
function PanelInformation(){
	...
	this.init = function(canvas, activityData){
		...
		myImage.src = "./images/" + activityData.celllist[0].cell[0].atributs.image;
		
		document.getElementById('image').src = "./images/" + activityData.celllist[0].cell[0].atributs.image;	
